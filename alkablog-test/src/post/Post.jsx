...
export default function Post() {
  ...
  useEffect(() => {
    ...
    async function carregarDetalhesPost() {
      ...
      try {
        const response = await configAxios.get(`/posts/${parseInt(id)}`)
    ...
    async function carregarDetalhesUsuario() {
      ...
      try {
        const response = await configAxios.get(`/users/${parseInt(userId)}`)
    ...
    async function carregarComentarios() {
      ...
      try {
        const response = await configAxios.get(`/posts/${parseInt(userId)}/comments`)
